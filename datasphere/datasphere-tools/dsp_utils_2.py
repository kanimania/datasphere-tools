...
class dspUtils:
    ...
    def logoutlogin(dsp_logon_data_file):
        ...
        json_data = dspUtils.read_json_file(dsp_logon_data_file)        
        ...
        for row in csv_data:
            ...
            if tabname not in json_dict:
                if json_template:
                    ...
                    json_dict[tabname]["definitions"][tabname]["@EndUserText.label"] = tabname
    ...
    def create_json_files_from_csv(csv_file, dsp_object_type=None):
        ...
        if dsp_object_type is None:
            raise ValueError('No Datasphere object type specified. Please provide a valid type.')
